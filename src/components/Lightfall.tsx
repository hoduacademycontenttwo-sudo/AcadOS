...
export const Lightfall: React.FC<LightfallProps> = ({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      if (programRef.current) callIfFn(programRef.current, 'remove');
      if (geometryRef.current) callIfFn(geometryRef.current, 'remove');
      if (meshRef.current) callIfFn(meshRef.current, 'remove');
      if (rendererRef.current) callIfFn(rendererRef.current, 'destroy');
